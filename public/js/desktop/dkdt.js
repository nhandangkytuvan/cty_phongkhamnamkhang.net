document.writeln("<style>" +
    ...
    ".dangkysdt:hover .fp-ph-img-circle{background: #baf5a7 url(http://localhost/cty_phongkhamnamkhang.net/public/images/global/ringcall/ico_dienthoai.gif) no-repeat center center;background-size: 70%;}" +
...
var str_html='<div class="dangkysdt" id="dangkysdt">' +
    ...
    var str_html2='<div id="popup_dangkysdt">' +
        ...
        '<div class="popup_dangkysdt_tb" style="display:none;"><p><img src="http://localhost/cty_phongkhamnamkhang.net/public/images/global/ringcall/ok.png"></p><p>Yêu cầu gọi lại đã được gửi đến bác sỹ, mong bạn nhẫn nại chờ đợi!</p></div>'+
    ...
    $(".popup_dangkysdt_dangky").on("click", function (e) {
        ...
        return false;
            ...
            if(checkmobile==0){
                ...
                var url = 'http://localhost/cty_phongkhamnamkhang.net/sendphone';
