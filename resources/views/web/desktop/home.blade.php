	...
	<main class="home">
		...
		<div class="row4">
			<div class="container">
				<div>
					<a href="{{ url('/ve-chung-toi') }}">
						<img src="{{ asset('public/images/desktop/home-4.png') }}" alt="" class="center-block">
					</a>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div>
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">
						<img src="{{ asset('public/images/desktop/home-6.png') }}" alt="" class="center-block">
					</a>
				</div>
			</div>
		</div>
		...
		<div class="row9">
			<div class="container">
				<div>
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">
						<img src="{{ asset('public/images/desktop/home-8.png') }}" alt="" class="center-block">
					</a>
				</div>
			</div>
		</div>
		...
		<div class="row12">
			<div class="container">
				<div>
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">
						<img src="{{ asset('public/images/desktop/home-10.png') }}" alt="" class="center-block"></a>
				</div>
				<p class="text-justify">
