...
@section('banner')
	<div>
		<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">
			@if($data['post']->id==424)
				<img src="{{ asset('public/images/chuyende/mobile/daibaoquydau/daibaoquydau-1.png') }}" alt="" class="center-block img-responsive">
			@else
	...
	<div class="container footer-toolbar">
		<table style="border-spacing: 0;width: 100%;">
			<tr>
				<td>
					<a href="tel:18006181">
						<img src="{{ asset('public/images/mobile/leftcall.png') }}" alt="" class="img-responsive center-block">
					</a>	
				</td>
				<td>
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">
						<img src="{{ asset('public/images/mobile/hbottom.gif') }}" alt="" class="img-responsive center-block">
					</a>
				</td>
			</tr>
		</table>
